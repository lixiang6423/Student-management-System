...
class JF_view_sysset_student extends JFrame {
    /**
     * @lixiang
     */
    ...
    // 添加一条数据
    public void jBadd_actionPerformed(ActionEvent e) {//添加的方法
        String classid = null;
    ...
    public void jBexit_actionPerformed(ActionEvent e) {//退出
    ...
    public void jBsave_actionPerformed(ActionEvent e) {
        ...
        if (result == JOptionPane.NO_OPTION)
            return;
        Obj_student object = new Obj_student();
        ...
        if (adapter.InsertOrUpject(object)) {
            ActionEvent event = new ActionEvent(jBrefresh, 0, null);
            jBrefresh_actionPerformed(event);
        }
    }

    public void jBrefresh_actionPerformed(ActionEvent e) {//更改
...
class JF_view_student_jComboBox2_itemAdapter implements ItemListener {
    private JF_view_sysset_student adaptee;

    JF_view_student_jComboBox2_itemAdapter(JF_view_sysset_student adaptee) {
...
class JF_view_student_jComboBox1_itemAdapter implements ItemListener {
    ...
    JF_view_student_jComboBox1_itemAdapter(JF_view_sysset_student adaptee) {
        this.adaptee = adaptee;
    }
...
class JF_view_student_jTable1_mouseAdapter extends MouseAdapter {
    ...
    JF_view_student_jTable1_mouseAdapter(JF_view_sysset_student adaptee) {
        this.adaptee = adaptee;
    }
...
class JF_view_student_jBdel_actionAdapter implements ActionListener {
    ...
    JF_view_student_jBdel_actionAdapter(JF_view_sysset_student adaptee) {
        this.adaptee = adaptee;
    }
...
class JF_view_student_jBrefresh_actionAdapter implements ActionListener {
    ...
    JF_view_student_jBrefresh_actionAdapter(JF_view_sysset_student adaptee) {
        this.adaptee = adaptee;
    }
...
class JF_view_student_jBexit_actionAdapter implements ActionListener {
    ...
    JF_view_student_jBexit_actionAdapter(JF_view_sysset_student adaptee) {
        this.adaptee = adaptee;
    }
...
class JF_view_student_jBadd_actionAdapter implements ActionListener {
    ...
    JF_view_student_jBadd_actionAdapter(JF_view_sysset_student adaptee) {
        this.adaptee = adaptee;
    }
...
class JF_view_student_jBsave_actionAdapter implements ActionListener {
    ...
    JF_view_student_jBsave_actionAdapter(JF_view_sysset_student adaptee) {
        this.adaptee = adaptee;
    }
